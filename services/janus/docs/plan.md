...
>
> ```
> rtpproxy      10200 – 20000 (기본 최대)
> Janus WebRTC  20000 – 20200        ← 20000 이 겹친다
> ```
>
> 부딪힐 확률은 낮지만, 5단계에서 원인 모를 미디어 실패가 나면 여기를 먼저
> 보세요. 겹침을 없애려면 `janus.jcfg` 의 `rtp_port_range` 를 `20100-20300`
> 처럼 올리거나 rtpproxy 의 `-M` 을 낮춥니다.
...
| 12 | 미디어가 안 붙음 / 포트 충돌 | rtpproxy(10200-20000)와 Janus WebRTC(20000-20200)가 20000 에서 겹친다 | 5단계에서 원인 모를 실패가 나면 여기부터 |
