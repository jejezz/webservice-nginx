...
const SERVICE_NAME = 'route-c';
const port = process.env.PORT || 28082;
const startedAt = Date.now();

// Nginx가 URI를 그대로 전달하므로(/route-c/...) 접두사를 제거한 뒤 라우팅한다.
const BASE_PATH = process.env.BASE_PATH || '/route-c';
