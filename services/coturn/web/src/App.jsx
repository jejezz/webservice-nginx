...
import { Activity, ArrowLeft, ScrollText, SlidersHorizontal } from 'lucide-react';
    ...
    <header className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 pt-3 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold leading-tight">coturn</h1>
            <p className="text-xs text-muted-foreground">TURN/STUN — 셀룰러 모바일 NAT 통과</p>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <a
            href="/janus/dashboard"
