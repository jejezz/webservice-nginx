...
/**
 * 로그 — 이 서비스는 pm2 가 아니라 **apt 패키지의 systemd 유닛**이 띄우므로
 * 로그가 저널에만 있습니다. `pm2 logs` 로는 보이지 않아서, 터미널을 열지
 * 않고도 볼 수 있게 여기 둡니다 (services/janus/web 의 같은 컴포넌트를
 * 그대로 옮겼습니다).
 *
...
export default function LogsView({ unit, hint }) {
    ...
    <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              <Input
                ...
                placeholder="필터 (정규식) — 예: allocate|4477"
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            이 서비스는 <strong>pm2 가 아니라 apt 패키지의 systemd 유닛</strong>이 띄웁니다 —{' '}
            <span className="font-mono">pm2 logs</span> 에는 나오지 않습니다. 이 대시보드 자체의 로그는{' '}
            <span className="font-mono">pm2 logs coturn-dashboard</span> 나{' '}
