...
| `2223` | UDP (127.0.0.1) | rtpengine 컨트롤 소켓 (`ng` 프로토콜) | ❌ 루프백 전용 |
...
전부 `127.0.0.1` 백엔드입니다. 이 저장소가 아는 서비스만 적었습니다 —
...
| coturn-dashboard | 28092 |
| websocket-relay | 28099 |

새 서비스를 추가할 때는 위와 겹치지 않는 `28080`대 번호를 쓰면 됩니다 —
[service-rollout.md](service-rollout.md)의 순서를 그대로 따르세요.
