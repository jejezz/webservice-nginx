...
import { ArrowLeft, DoorOpen, House, Radio, Smartphone } from 'lucide-react';
    ...
    <header className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 pt-3 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold leading-tight">RTC Relay</h1>
            <p className="text-xs text-muted-foreground">WebRTC 시그널링 · IoT 릴레이 관리</p>
          </div>
        </div>
